...
Path aggregate items can also include provider-agnostic source screenshot fields:
...
These are report references only. This package does not capture screenshots or depend on a
specific screenshot provider.
